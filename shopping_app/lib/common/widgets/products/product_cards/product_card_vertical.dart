        ...
        child: Column (
          children: [
            RoundedContainer (
              ...
              child:  Stack (
                children: [ 
                  const RoundedImage(imageUrl: TImages.productImage_2, applyImageRadius: true),
                  Positioned (
                    top: 12,
            ...
            Padding (
              ...
              child: Column (
                ...
                children: [
                  const ProductTitleText(title: "Black Nike are", smallSize: true),
                  const Gap(TSizes.spaceBtwItems / 2),
                  ...
                  Row (
                    ...
                    children: [
                      const ProductPriceText(price: '35', isLarge: false),
